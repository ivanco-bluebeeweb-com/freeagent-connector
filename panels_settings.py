"""Settings panel for FreeAgent Connector."""
from __future__ import annotations
from imperal_sdk import ui
from app import ext

@ext.panel("__freeagent_settings", slot="center")
async def settings_panel(ctx) -> ui.UINode:
    disconnect_form = ui.Form(
        # id=freeagent_form",
        submit_label="Disconnect Active Account",
        action=ui.Call("disconnect_freeagent"),
        children=[
    ...
    return ui.Stack(
        children=[
            ui.Heading("FreeAgent Settings & Accounts", level=2),
