# Plausible Scenario Tests (PST) — FreeAgent Connector
...
- `connect_freeagent`: validated contract & error handling
- `list_connections`: validated contract & error handling
- `disconnect_freeagent`: validated contract & error handling
